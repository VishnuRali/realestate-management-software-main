...
class Database:
    ...
    # Property-related database methods
    def add_property(
        self,
        address,
        property_type,
    ...
    def delete_property(self, property_id):
        ...
        self.cursor.execute(
            "DELETE FROM inquiries WHERE property_id = ?", (property_id,)
        )
        # Delete the property
    ...
    # Agent-related database methods
    ...
    def update_agent(
        self, agent_id, name, phone, email, license_number, commission_rate
    ):
    ...
    def delete_agent(self, agent_id):
        ...
        self.cursor.execute(
            "UPDATE properties SET agent_id = NULL WHERE agent_id = ?", (agent_id,)
        )
        self.cursor.execute(
            "UPDATE inquiries SET agent_id = NULL WHERE agent_id = ?", (agent_id,)
        )
    ...
    def get_agents(self):
        ...
        self.cursor.execute(
            """
            SELECT id, name, phone, email, license_number, join_date, commission_rate FROM agents
            ORDER BY name
        """
        )
        return self.cursor.fetchall()
    ...
    # Inquiry-related database methods
    def add_inquiry(
        self, client_name, contact_info, property_id, status, notes, agent_id
    ):
